...
$file = new PHPExcel ();
    ...
    $file->getProperties ()->setTitle ( "Test Data" );
    $file->getProperties ()->setSubject ( "Test Data" );
    $file->getProperties ()->setDescription ( "Test Data" );
    $file->getProperties ()->setKeywords ( "Test Data" );
    $file->getProperties ()->setCategory ( "Data Test Data" );
...
include "../koneksi.php";
    ...
    $result =mysql_query("SELECT * FROM data_uji ORDER BY id ");
...
/* start - BLOCK MEMBUAT LINK DOWNLOAD*/
    ...
    header ( 'Content-Disposition: attachment;filename="Test Data.xls"' ); 
