                    ...
                    <table border="1" align="center">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Jumlah K</th>
                                ...
                                <th class="text-center">Kelas Asli</th>
                                <th class="text-center">kelas klasifikasi</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text"><?php echo $a['jumlah_k'] ?></td>
                                ...
                                <td class="text-center"><?php echo $a['kelas'] ?></td>
